...
def t1():
    try:
        ...
        while True:
            ...
            # _cur = driver.current_activity
            # print(_cur)
            # driver.start_activity(app_activity="com.ss.android.article.lite.activity.SplashActivity --user 10",app_package="com.f101.android",dontStopAppOnReset=True)
            time.sleep(3)  
            print(f"001")
            ...
            # driver.start_activity(app_activity="com.ss.android.article.lite.activity.SplashActivity",app_package="com.f101.android",dontStopAppOnReset=True)
            # time.sleep(3)     
            # # _cur = driver.get_current_activity()
            # # print(_cur)
            # apih.find_by_xpath(driver,xpath='//android.widget.EditText[@resource-id="com.f101.android:id/alq"]').send_keys("188")       
            # print(f"002")
            time.sleep(3) 
            # 你的其他操作
            # ...
